...
const Welcome = () => {
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center bg-gradient-to-r from-blue-500 to-purple-200">
      <div className="w-[90%] h-[95%] flex justify-center gap-24 bg-white shadow-2xl border rounded-xl p-3 border-purple-300 mobile:w-full mobile:h-auto md:w-[80%] lg:w-[95%] lg:gap-12 lg:h-[92%] xl:gap-24 xl:h-[95%] xl:w-[90%]">
        ...
        <div className="w-[45%] flex justify-center items-center animate-fadeIn mobile:hidden lg:block mobile:w-full lg:w-[45%] ">
          <img
