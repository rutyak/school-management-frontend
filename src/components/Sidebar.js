...
const Sidebar = ({ openMenu, setOpenMenu }) => {
  ...
  const activeStyle =
    "md:py-2 md:pl-2 md:bg-white md:text-blue-500 md:border md:rounded-xl md:mobile:w-[80%]";
  ...
  return (
    <div
      ...
      } mobile:w-[13%] mobile:p-0 mobile:rounded-none mobile:m-0 sm:w-[10%] md:w-[13%] lg:w-[10%] xl:w-[calc(14%+6px)] xl:translate-x-0 xl:rounded-xl xl:h-[calc(94%+3px)]`}
    >
      <div className="flex items-center justify-center p-1 pb-9 font-bold text-2xl lg:gap-2 xl-4">
        <img
          className="w-[26%] mobile:w-[70%] mobile:mt-3"
      ...
      <div className="sidebar-content ml-4 mobile:ml-3 sm:ml-4 lg:ml-7 xl:ml-4">
        <Link
          to="/main/"
